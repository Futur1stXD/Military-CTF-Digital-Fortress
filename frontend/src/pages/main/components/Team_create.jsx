                ...
                {isTeamExist ?
                    ...
                    >
                        <Card className={isPhone ? "bg-card border-none w-5/6" : "bg-card border-none w-3/6"}>
                            ...
                            {isPhone ? <p className="text-white tracking-wide" style={{ wordWrap: 'break-word' }}><ShrinkOutlined style={{ paddingRight: 10 }} />Для приглашения: {invite}</p> : <h4 className="text-white tracking-wide"><ShrinkOutlined style={{ paddingRight: 10 }} />Для приглашения: {invite}</h4>}
